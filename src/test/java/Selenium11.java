...
public class Selenium11 {
    ...
    @Test(priority = 50)
    public void userCannotLogInWithBothUsernameAndPasswordFieldsEmpty() throws InterruptedException {
    ...
    @Test(priority = 60)
    public void userCannotLogInWithValidUsernameAndEmptyPasswordField() throws InterruptedException {
        WebElement error = driver.findElement(By.id("error"));
        usernameField.sendKeys(validUsername);
        submitButton.click();
        String errorMessage = error.getText();;
